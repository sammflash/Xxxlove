...
-- you like — never required. is_owner=1 is permanent: only this account
-- (or whichever account you manually flip is_owner on in the database)
-- can suspend or delete other admin/moderator/creator accounts.
