 ...
 *   ('dashboard'|'videos'|'categories'|'accounts'|'code'|'comments'|'settings'),
 *   $pendingReportsCount (int, optional), $pendingCommentsCount (int, optional)
 */
$active = $active ?? '';
...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="/admin/categories.php" class="<?= $active === 'categories' ? 'active' : '' ?>">
    ...
    <?php if ($canModerate): ?>
      ...
      <a href="/admin/comments.php" class="<?= $active === 'comments' ? 'active' : '' ?>" style="justify-content:space-between;">
        <span style="display:flex; align-items:center; gap:12px;">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
          Comments
        </span>
        <?php if ($pendingCommentsCount > 0): ?>
          <span class="sidebar-badge"><?= (int) $pendingCommentsCount ?></span>
        <?php endif; ?>
      </a>
    <?php endif; ?>
    <?php if ($canAdminister): ?>
      ...
      <a href="/admin/settings.php" class="<?= $active === 'settings' ? 'active' : '' ?>">
